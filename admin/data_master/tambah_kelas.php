...
// Ambil Tahun Ajaran Aktif (Opsional, jika ada tabel tahun_ajaran)
// $koneksi->query(...)
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        /* Gunakan CSS yang sama persis dengan tambah_guru.php di atas */
    ...
    <div class="main-content">
        <header class="header">
            <div class="header-left">
                ...
                <div class="header-title">Sistem Raport</div>
            </div>
